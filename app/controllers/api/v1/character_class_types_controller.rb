class API::V1::CharacterClassTypesController < ApplicationController
  ...
  # GET /api/v1/character_class_types
  # GET /api/v1/character_class_types.json
  def index
  ...
  # GET /api/v1/character_class_types/1
  # GET /api/v1/character_class_types/1.json
  def show
    render json: @character_class_type
  end

  # POST /api/v1/character_class_types
  # POST /api/v1/character_class_types.json
  def create
  ...
  # PATCH/PUT /api/v1/character_class_types/1
  # PATCH/PUT /api/v1/character_class_types/1.json
  def update
  ...
  # DELETE /api/v1/character_class_types/1
  # DELETE /api/v1/character_class_types/1.json
  def destroy
