class API::V1::CharacterRaceThiefTalentsController < ApplicationController
  ...
  private
    ...
    def character_race_thief_talent_params
      params.require(:character_race_thief_talent).permit(:lockpick_mod, :find_traps_mod, :climb_mod, :silent_movement_mod, :stealth_mod, :pickpocket_mod, :hear_noises_mod, :backstab_mod, :character_race_id)
    end
end
