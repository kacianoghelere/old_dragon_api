...
# ActiveRecord::Schema.define(version: 20170119161614) do
    ...
    # create_table :character_expertises, id: false do |t|
    #   t.integer  :character_sheet_id, limit: 8, null: false
    #   t.integer  :expertise_id,       limit: 8, null: false
    #   t.timestamps null: false
    # end

    # add_index :character_expertises, [:character_sheet_id], using: :btree
    ...
    # add_index :character_journals, [:character_sheet_id], using: :btree
    ...
    # add_foreign_key :character_expertises, :character_sheets
    # add_foreign_key :character_expertises, :expertises
    # add_foreign_key :character_journals, :alignments
    # add_foreign_key :character_journals, :character_sheets
