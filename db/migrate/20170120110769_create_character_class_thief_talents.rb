class CreateCharacterClassThiefTalents < ActiveRecord::Migration
  def change
    create_table :character_class_thief_talents, id: :bigint do |t|
    ...
    add_index :character_class_thief_talents, [:character_class_id], using: :btree
  end
end
